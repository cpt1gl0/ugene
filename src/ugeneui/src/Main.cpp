...
int main(int argc, char **argv)
{
    ...
    QObject::connect(ts, SIGNAL(si_loadingIsFinished()), splashScreen, SLOT(sl_close()));
    QObject::connect(ts, SIGNAL(si_loadingIsFinished()), mw, SLOT(sl_show()));

    WelcomePageMdiController *wpc = new WelcomePageMdiController();
    QObject::connect(ts, SIGNAL(si_loadingIsFinished()), wpc, SLOT(sl_showPage()));
