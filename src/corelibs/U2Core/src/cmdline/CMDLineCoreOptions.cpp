...
const QString CMDLineCoreOptions::DOWNLOAD_DIR_PATH             = "download-dir-path";
const QString CMDLineCoreOptions::CUSTOM_TOOLS_CONFIG_DIR_PATH  = "custom-tools-config-dr-path";
const QString CMDLineCoreOptions::TMP_DIR                       = "tmp-dir";
const QString CMDLineCoreOptions::DEFAULT_DATA_DIR_PATH         = "default-data-dir-path";
const QString CMDLineCoreOptions::FILE_STORAGE_DIR              = "file-storage-dir";
const QString CMDLineCoreOptions::USER_DIR                      = "user-dir";
const QString CMDLineCoreOptions::EXTERNAL_TOOL_DIR             = "external-tool-dir";
const QString CMDLineCoreOptions::INCLUDED_ELEMENTS_DIR         = "included-elements-dir";
const QString CMDLineCoreOptions::WORKFLOW_OUTPUT_DIR           = "workfow-output-dir";
